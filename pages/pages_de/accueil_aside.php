...
<ul class="menu_aside">
	<li><a rel="nofollow" href="http://modiqua.eu/index.php?page=acces_membre&amp;categ=login">Partner Zugang</a></li>
	<li><a href="http://modiqua.eu/devis">Ihren Online-Angebot</a></li>
</ul>
...
<?php 
	...
	while ($row = mysql_fetch_assoc($req)){
		...
		//affichage
		?><li><?php echo $resume_news ?><br/><a href="http://modiqua.eu/news/news-<?php echo $id_news ?>">Lesen mehr</a></li> <?php
	}
?>
	</ul>
	<span class="lire_infos"><a href="http://modiqua.eu/news">Alles news lesen</a></span>
</div>

<br/>

<h1>ZEUGNIS</h1> <!-- LISTE DES TEMOIGNAGES SUR L'ASIDE -->
<div class="fieldset">
	<ul>
<?php 
	//connection à la BDD
	...
	while ($row = mysql_fetch_assoc($req)){
		...
		//affichage
		?><li><?php echo $resume_temoignage ?><br/><a href="./index.php?page=temoignage&amp;id_temoignage=<?php echo $id_temoignage ?>">Lesen mehr</a></li> <?php
	}
?>
	</ul>
	<span class="lire_infos"><a href="./index.php?page=temoignage">Alles zeugnis lesen</a></span>
</div>