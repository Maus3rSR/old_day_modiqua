...
if (isset($_GET['categ']) && !empty($_GET['categ'])){
	...
	if ($categ == 'machines_et_gabarits'){ /* ***************SOUSMENU MACHINES SPECIALES ET GABARITS*********************** */
		...
		<p>-D'<strong>interfaces de test</strong> pour l'industrie électrique et de <strong>bancs de test</strong> divers </p>
...
<li><strong>L'étude et la réalisation de machines spéciales automatisées et de gabarits divers</li> 
<li><strong>L'usinage de précision et l'électroérosion</li>
<li><strong>La réparation de moules pour injection plastique et d'outillages divers</li></p> 
...
</p>Avantages pour nos clients : 	<li><strong>Une solution technique parfaitement adaptée 
									<li>Un interlocuteur unique
									<li>Une qualité, un coût et un délai maîtrisés</strong><p>
