...
<?php 
		...
		if($poste == 'techBE'){
			...
			?>
			<p>le Technicien/Technicienne bureau d'étude réalise la conception et les dessins de définitions des projets dont il est responsable. Les travaux sont faits sur la base des cahiers de chages élaboré par les clients.</p>
			...
			//TEXTE DE PRESENTATION BTS Alternance
			?>
			<p>Nous recherchons un(e) jeune titulaire d'un BAC souhaitant se former à travers la voie de l'alternance. Nous proposons un BTS étude et réalisation d'outillage dispensé par le CFAI de St Marguerite dans les Vosges. Titulaire de ce BTS, une personne de valeur aura des perspectives interessantes pour évoluer au sein de la société. Merci de bien vouloir nous contacter pour toute information complémentaire.</p>
